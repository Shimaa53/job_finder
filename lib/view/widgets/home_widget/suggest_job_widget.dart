...
import 'package:job_finder/model/job_model/home_model.dart';
...
// SuggestJobModel buildSuggestJob,
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  //buildSuggestJob.image
                  Image.asset(AppAssets.zoomLogo,height: 6.2.h,width:10.w),
                  buildSizedBox(width: 4.w,),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children:[
                        //AppString.productDesigner
                        DefaultText(text:AppString.productDesigner.toString(),fontSize: 13.sp,
